...
final class PaiementController extends AbstractController
{
    ...
    #[Route('/paiement/{id}/invoice', name: 'paiement_invoice')]
    public function generateInvoice(Paiement $paiement): Response
    {
        $dompdf = new Dompdf();
        $html = $this->renderView('paiement/invoice.html.twig', [
            'paiement' => $paiement,
        ]);
